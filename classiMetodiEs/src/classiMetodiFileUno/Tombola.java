...
// simula il gioco della tombola con regole simili al reale in modo automatico
...
// sa verificare e dichiarare se ha fatto ambo terno quaterna o tombola
...
public class Tombola {
	...
	public static void turnoStep() {
		...
		if(numEstratti.size() >= 2) {//salto prima estrazione
		...
		//step fase  finale stampe
		System.out.println(" ");
		
		// prima di ordinare osservo l ultimo numero nell array estratti
		System.err.println("ULTIMO ESTRATTO : " + numEstratti.getLast().toString());
		
		// si puo velocemente mettere in ordine per maggior leggibilita
		numEstratti.sort(null);
		
		// PRINTI NUMERI ESTRATTI
		System.out.println(" ");
		System.out.print("NUM ESTRATTI: ");
	...
	public static boolean[][] giocatoriNumEstratti(int nGiocatori, 
			List<Integer> nEstratti, int[][][] schedGiocatori, boolean[][] resGiocatori ){
	...
	public static void ciaoTombola(){
		...
		System.out.println("ciao io sono simulazione di tombola");
